...
#PBS -N 2M2224_pow
#PBS -m abe
#PBS -l select=1:ncpus=1:mpiprocs=1:model=has+5:ncpus=15:mpiprocs=15:model=has
...
mpiexec -machinefile $PBS_NODEFILE -np 76 python brewster_pow_RFalks.py > /nobackup/bburning/brew_2M2224spex_pow.log
