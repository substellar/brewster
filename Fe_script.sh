...
#PBS -N 2M2224_mie_Fe
#PBS -m abe
#PBS -l select=1:ncpus=1:mpiprocs=1:model=has+5:ncpus=18:mpiprocs=18:model=has
...
mpiexec -machinefile $PBS_NODEFILE -np 91 python brewster_mie_Fe.py > /nobackup/bburning/brew_2M2224spex_mie_Fe.log
