...
setenv PATH ${PATH}:/home1/bburning/retrievals/2m0355spex_grey:/u/scicon/tools/bin
setenv LD_LIBRARY_PATH ${LD_LIBRARY_PATH}:/home1/bburning/retrievals/2m0355spex_grey
...
cd /home1/bburning/retrievals/2m0355spex_grey
...
mpiexec -machinefile $PBS_NODEFILE -np 86 python brewster.py > brew_2M0355spex.log
