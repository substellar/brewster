...
for result in sampler.sample(p0, iterations=15000):
    ...
    f.close()
    #'''
    if (k==100 or k==1000 or k==2000 or k==2500 or k==3000 or k==3500 or k==4000 or k==4500 or k==5000 or k==6000 or k==7000 or k==8000 or k==9000 or k==10000 or k==11000 or k==12000 or k==14000 or k==18000 or k==21000 or k==25000):
        chain=sampler.chain
