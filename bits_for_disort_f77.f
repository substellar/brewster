         SUBROUTINE  GETMOM( IPHAS, GG, NMOM, MOMALPHA, PMOM )
...
c                      6 : Combined Rayleigh and HG phase functions
...
c                                        ** Combined Rayleigh and HG
         DO  50  K = 1, NMOM
            PMOM(K) = (1.-MOMALPHA)*(GG**K)
 50      CONTINUE
         
         PMOM(2) = MOMALPHA*0.1 + PMOM(2)
